...
const serverUrl = "http://localhost:50529/";
const serverUrlTicket = "http://localhost:50555/";
...
export const environment = {
  ...
  URLS: {
    ...
    GetObjectURL: `${BaseUrl}ContextVariable/GetObject`,
    ...
    GetAllAImodels: `${BaseUrl}AIModels/GetAll`,
    SaveAIModel: `${BaseUrl}AIModels/Save`,
    ...
    GetAllAIIntents: `${BaseUrl}AiAgent/GetAllAIIntents`,
    UpsertAIIntent: `${BaseUrl}AiAgent/UpsertAIIntent`,
    DeleteAIIntent: `${BaseUrl}AiAgent/DeleteAIIntent`,
    ...
    saveSubAgents: `${BaseUrl}AiAgent/SaveSubAgents`,
